...
| :--- | :--- | :--- |
| **[Library_API](https://github.com/darshan3751/Library_API)** | A RESTful Library Management API built using Flask and MySQL for managing authors and books. | `Python`, `Flask`, `MySQL`, `REST API` |
